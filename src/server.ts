...
Generate 1 new feature task inspired by Jules' changelog (https://jules.google/docs/changelog/) and codegen docs (https://docs.codegen.com/introduction/overview) as roadmap of development.
